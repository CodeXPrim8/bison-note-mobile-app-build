(function () {
  ...
  var label = script.getAttribute('data-button-text') || 'Buy tickets';
  var theme = script.getAttribute('data-theme') || 'theme-pink';
  ...
  button.addEventListener('click', function () {
    ...
    if (frame) frame.src = origin + '/t/' + encodeURIComponent(eventSlug) + '?embed=1&theme=' + encodeURIComponent(theme);
